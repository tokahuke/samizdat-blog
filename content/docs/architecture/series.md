...
identity of the series; it is what consumers subscribe to and what
appears in the canonical
`http://localhost:4510/_series/<base64-public-key>/` URL. Anyone who
can sign with the matching private key can publish new editions; that
is the entire authentication story for the network layer.
...
`http://localhost:4510/_series/<key>/some/path/`, the local node:
